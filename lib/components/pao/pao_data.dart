class PAOData {
  ...
  PAOData(this.index, this.digits, this.person, this.action, this.object, this.familiarity);
  ...
  factory PAOData.fromJson(Map<String, dynamic> json) {
    return new PAOData(json['index'], json['digits'], json['person'], json['action'],
        json['object'], json['familiarity']);
  }
}

var defaultPAOData = [
  PAOData(0, '00', 'Ozzy Osbourne', 'rocking out a concert', 'rock guitar', 100),
  PAOData(1, '01', 'Prairie Johnson', 'dancing metaphorically', 'halo', 100),
  PAOData(2,
      '02', 'Orlando Bloom', 'walking the plank', 'pirate sword, eyepatch', 100),
  PAOData(3, '03', 'Thomas Nguyenfa', 'jetskiing', 'jetski, pharmacy drugs', 100),
  PAOData(4, '04', 'Oscar De La Hoya', 'boxing', 'boxing gloves', 100),
  PAOData(5, '05', 'Asami-san', 'writing/reading test report', 'FADEC', 100),
  PAOData(6, '06', 'Steve Jobs', 'typing on laptop', 'macbook / iphone', 100),
  PAOData(7, '07', 'Oscar the grouch', 'complaining', 'trashcan', 100),
  PAOData(8, '08', 'Spiderman', 'shooting a web', 'giant spiderweb', 100),
  PAOData(9,
  ...
  PAOData(12, '12', 'Antonio Banderas', 'fencing as Zorro', 'Zorros mask', 100),
  PAOData(13, '13', 'Augustus Caesar', 'conquering Europe', 'leaf crown', 100),
  PAOData(14, '14', 'Jesus', 'water into wine', 'cross', 100),
  ...
  PAOData(18, '18', 'Adolph Hitler', 'committing genocide', 'gas chamber', 100),
  ...
  PAOData(27, '27', 'Tyler1', 'CSing minions', 'spinning axes', 100),
  ...
  PAOData(49, '49', 'Mazy', 'on conference call', 'stool', 100),
  ...
  PAOData(56, '56', 'Ellie Fung', 'sex on air mattress', 'air mattress', 100),
  PAOData(57,
  ...
  PAOData(64, '64', 'Lori', 'sex in field', 'field of grass', 100),
