...
var defaultActivityStatesInitial = {
  ...
  planetTimedTestPrepKey: Activity(planetTimedTestPrepKey, 'todo', false, DateTime.now(), true),
  planetTimedTestKey: Activity(planetTimedTestKey, 'todo', false, DateTime.now(), true),
  ...
  airportTimedTestPrepKey: Activity(airportTimedTestPrepKey, 'todo', false, DateTime.now(), true),
  airportTimedTestKey: Activity(airportTimedTestKey, 'todo', false, DateTime.now(), true),
  ...
  face2TimedTestPrepKey: Activity(face2TimedTestPrepKey, 'todo', false, DateTime.now(), true),
  face2TimedTestKey: Activity(face2TimedTestKey, 'todo', false, DateTime.now(), true),
  piTimedTestPrepKey: Activity(piTimedTestPrepKey, 'todo', false, DateTime.now(), true),
...
var defaultActivityStatesChapter2Done = {
  ...
  planetTimedTestPrepKey: Activity(planetTimedTestPrepKey, 'review', true, DateTime.now(), false),
  planetTimedTestKey: Activity(planetTimedTestKey, 'review', false, DateTime.now(), false),
  ...
  airportTimedTestPrepKey: Activity(airportTimedTestPrepKey, 'review', true, DateTime.now(), false),
  airportTimedTestKey: Activity(airportTimedTestKey, 'review', false, DateTime.now(), false),
...
var defaultActivityStatesChapter3Done = {
  ...
  face2TimedTestPrepKey: Activity(face2TimedTestPrepKey, 'review', true, DateTime.now(), false),
  face2TimedTestKey: Activity(face2TimedTestKey, 'review', false, DateTime.now(), false),
  piTimedTestPrepKey: Activity(piTimedTestPrepKey, 'review', true, DateTime.now(), false),
  piTimedTestKey: Activity(piTimedTestKey, 'review', false, DateTime.now(), false),
  deckEditKey: Activity(deckEditKey, 'todo', false, DateTime.now(), true),
  deckPracticeKey: Activity(deckPracticeKey, 'todo', false, DateTime.now(), true),
  deckMultipleChoiceTestKey: Activity(deckMultipleChoiceTestKey, 'todo', false, DateTime.now(), true),
  deckTimedTestPrepKey: Activity(deckTimedTestPrepKey, 'todo', false, DateTime.now(), true),
...
var defaultActivityStatesAllDone = {
  ...
  phoneticAlphabetTimedTestPrepKey: Activity(phoneticAlphabetTimedTestPrepKey, 'review', true, DateTime.now(), false),
  phoneticAlphabetTimedTestKey: Activity(phoneticAlphabetTimedTestKey, 'review', false, DateTime.now(), false),
  airportTimedTestPrepKey: Activity(piTimedTestPrepKey, 'review', true, DateTime.now(), false),
  airportTimedTestKey: Activity(piTimedTestKey, 'review', false, DateTime.now(), false),
  paoEditKey: Activity(paoEditKey, 'review', true, DateTime.now(), false),
  paoPracticeKey: Activity(paoPracticeKey, 'review', true, DateTime.now(), false),
  paoMultipleChoiceTestKey: Activity(paoMultipleChoiceTestKey, 'review', true, DateTime.now(), false),
  paoTimedTestPrepKey: Activity(paoTimedTestPrepKey, 'review', true, DateTime.now(), false),
  ...
  deckTimedTestPrepKey: Activity(deckTimedTestPrepKey, 'review', true, DateTime.now(), false),
  deckTimedTestKey: Activity(deckTimedTestKey, 'review', false, DateTime.now(), false),
};
