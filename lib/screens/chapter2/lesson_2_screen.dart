...
class _Lesson2ScreenState extends State<Lesson2Screen> {
  ...
  final List<SlidingTileContent> tiles = [
    SlidingTileContent(
      header: 'Chapter 2: The Memory Palace',
      content: [
        Text(
    ...
    SlidingTileContent(
      ...
      content: [
        Text(
          '    The memory palace is extremely powerful only because all of us are so good at remembering the '
    ...
    SlidingTileContent(
      ...
      content: [
        Text(
          ...
          '\n\n    We might want to start at the front door, and work our way around the area. We can go room by room, '
    ...
    SlidingTileContent(
      header: 'Setting up the location!',
      content: [
        Text(
